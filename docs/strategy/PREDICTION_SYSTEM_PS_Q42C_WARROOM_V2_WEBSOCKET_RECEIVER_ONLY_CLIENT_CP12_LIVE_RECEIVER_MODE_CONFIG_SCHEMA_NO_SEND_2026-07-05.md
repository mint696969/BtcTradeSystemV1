# path: ./docs/strategy/PREDICTION_SYSTEM_PS_Q42C_WARROOM_V2_WEBSOCKET_RECEIVER_ONLY_CLIENT_CP12_LIVE_RECEIVER_MODE_CONFIG_SCHEMA_NO_SEND_2026-07-05.md
# desc: PS-Q42C WarRoom v2 receiver-only client cp12_live_receiver_mode_config_schema no-send. CP12 operator-facing live mode danger-zone dry-run only.

# PS-Q42C WarRoom v2 receiver-only client cp12_live_receiver_mode_config_schema no-send

Date: 2026-07-05
Profile: BtcTradeSystem
Base gate: PS_CP11_WARROOM_V2_WEBSOCKET_RECEIVER_ONLY_CLIENT_TOPIC_WIDGETS_DONE
Slice: PS-Q42C_WARROOM_V2_WEBSOCKET_RECEIVER_ONLY_CLIENT_CP12_LIVE_RECEIVER_MODE_CONFIG_SCHEMA_NO_SEND

## Decision

Live receiver mode config schema is default-off and does not enable connect, receive, reconnect, heartbeat, or send.

```text
live_receiver_mode_config_schema_ready=true
