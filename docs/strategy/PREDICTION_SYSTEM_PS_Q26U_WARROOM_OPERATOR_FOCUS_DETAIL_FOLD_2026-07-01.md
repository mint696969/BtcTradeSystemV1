# path: ./docs/strategy/PREDICTION_SYSTEM_PS_Q26U_WARROOM_OPERATOR_FOCUS_DETAIL_FOLD_2026-07-01.md
# desc: PS-Q26U folds the detailed WarRoom operator focus table by default to reduce first-screen density.
# PS-Q26U WarRoom operator focus detail fold

Updated: 2026-07-01 JST
Base: PS-Q26T WarRoom operator focus command cards
Mode: WarRoom UI visual tuning / first-screen density reduction / display-only / no runtime writes / no scheduler or producer enablement / no trading guidance

```text
ps_q26u_warroom_operator_focus_detail_fold=true
base_reentry=PS_Q26T_WARROOM_OPERATOR_FOCUS_COMMAND_CARDS_DONE
...
Q26U keeps the ①②③ command cards and the route strip visible, while folding the 5-step detailed table by default. This reduces first-screen density without deleting any information.
