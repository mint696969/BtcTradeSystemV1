# path: ./tools/test_phase4a_prediction_system_ps_q24k_autotrade_read_only_status_page_actual_page_wiring_human_gate_decision_close_guard.py
# desc: Close guard for PS-Q24K human-gate decision with page wiring still blocked.
...
EXPECTED_DIRTY = {
    ...
    "docs/strategy/PREDICTION_SYSTEM_PS_Q24K_AUTOTRADE_READ_ONLY_STATUS_PAGE_ACTUAL_PAGE_WIRING_HUMAN_GATE_DECISION_2026-06-29.md",
    "tools/diagnose_phase4a_prediction_system_ps_q23r_closeout_steady_state_guard_sync.py",
    "tools/diagnose_phase4a_prediction_system_ps_q24k_autotrade_read_only_status_page_actual_page_wiring_human_gate_decision.py",
    "tools/test_phase4a_prediction_system_ps_q24k_autotrade_read_only_status_page_actual_page_wiring_human_gate_decision.py",
    "tools/test_phase4a_prediction_system_ps_q24k_autotrade_read_only_status_page_actual_page_wiring_human_gate_decision_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        ...
        "guard": "ps_q24k_autotrade_read_only_status_page_actual_page_wiring_human_gate_decision_close_guard",
