# path: ./tools/test_phase4a_prediction_system_ps_q26k_allowed_tech_term_label_help_text_close_guard.py
# desc: Close guard for PS-Q26K allowed technical term label/help text.
...
EXPECTED_DIRTY = {
    ...
    "btcts_next/src/btcts/apps/operator_ui/tests/test_allowed_tech_term_label_help_text_q26k.py",
    "docs/strategy/PREDICTION_SYSTEM_PS_Q26K_ALLOWED_TECH_TERM_LABEL_HELP_TEXT_2026-07-01.md",
    "tools/diagnose_phase4a_prediction_system_ps_q26k_allowed_tech_term_label_help_text.py",
    "tools/test_phase4a_prediction_system_ps_q26k_allowed_tech_term_label_help_text.py",
    "tools/test_phase4a_prediction_system_ps_q26k_allowed_tech_term_label_help_text_close_guard.py",
}
