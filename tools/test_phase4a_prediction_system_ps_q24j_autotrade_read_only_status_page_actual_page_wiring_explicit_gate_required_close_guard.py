# path: ./tools/test_phase4a_prediction_system_ps_q24j_autotrade_read_only_status_page_actual_page_wiring_explicit_gate_required_close_guard.py
# desc: Close guard for PS-Q24J actual page wiring patch plan with explicit gate required.
...
EXPECTED_DIRTY = {
    ...
    "docs/strategy/PREDICTION_SYSTEM_PS_Q24J_AUTOTRADE_READ_ONLY_STATUS_PAGE_ACTUAL_PAGE_WIRING_EXPLICIT_GATE_REQUIRED_2026-06-29.md",
    "tools/diagnose_phase4a_prediction_system_ps_q23r_closeout_steady_state_guard_sync.py",
    "tools/diagnose_phase4a_prediction_system_ps_q24j_autotrade_read_only_status_page_actual_page_wiring_explicit_gate_required.py",
    "tools/test_phase4a_prediction_system_ps_q24j_autotrade_read_only_status_page_actual_page_wiring_explicit_gate_required.py",
    "tools/test_phase4a_prediction_system_ps_q24j_autotrade_read_only_status_page_actual_page_wiring_explicit_gate_required_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        ...
        "guard": "ps_q24j_autotrade_read_only_status_page_actual_page_wiring_explicit_gate_required_close_guard",
