# path: ./tools/test_phase4a_prediction_system_ps_q21d_warroom_prediction_refresh_live_badge_close_guard.py
# desc: Close guard for PS-Q21D WarRoom prediction refresh live badge.
...
from tools.test_phase4a_prediction_system_ps_q21d_warroom_prediction_refresh_live_badge import (  # noqa: E402
    FALSE_BOUNDARIES,
    REQUIRED_MARKERS,
    SPEC,
)
...
EXPECTED_DIRTY = {
    ...
    "docs/strategy/PREDICTION_SYSTEM_PS_Q21D_WARROOM_PREDICTION_REFRESH_LIVE_BADGE_2026-06-26.md",
    "tools/test_phase4a_prediction_system_ps_q21d_warroom_prediction_refresh_live_badge.py",
    "tools/test_phase4a_prediction_system_ps_q21d_warroom_prediction_refresh_live_badge_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        "ok": not failures,
        "guard": "ps_q21d_warroom_prediction_refresh_live_badge_close_guard",
        "contract": {
...
def test_ps_q21d_close_guard() -> None:
    assert main_guard() == 0
