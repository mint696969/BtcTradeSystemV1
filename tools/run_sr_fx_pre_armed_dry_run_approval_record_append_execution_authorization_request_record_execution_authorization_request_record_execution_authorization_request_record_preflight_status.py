# path: ./tools/run_sr_fx_pre_armed_dry_run_approval_record_append_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_status.py
# desc: Broker-free Pre-Armed Dry Run authorization request record execution authorization request record execution authorization request record preflight/status from S70. Preflight/status only; non-recording; non-executing; non-authorizing.
...
TOOL = "run_sr_fx_pre_armed_dry_run_approval_record_append_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_status"
REPORT_VERSION = "pre_armed_dry_run_approval_record_append_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_status.v1"
PREFLIGHT_SCOPE = "PRE_ARMED_DRY_RUN_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_REVIEW_ONLY"
PREFLIGHT_TARGET = "APPROVAL_RECORD_APPEND_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD"
REQUIRED_PREFLIGHT_ACKS = (
    "confirm_s70_record_execution_authorization_request_record_execution_authorization_request_status_reviewed",
...
def build_pre_armed_dry_run_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_status(*, record_execution_authorization_request_status: Mapping[str, Any], record_execution_authorization_request_record_preflight_review: Mapping[str, Any], generated_at: str | None = None) -> dict[str, Any]:
    ...
    request_ready = status.get("authorization_request_record_execution_authorization_request_record_execution_authorization_request_ready") is True
    request_observed = status.get("authorization_request_record_execution_authorization_request_record_execution_authorization_requested_observed") is True
    ...
    status_safety_ok = (
        ...
        and status.get("authorization_request_record_execution_authorization_request_record_execution_authorized") is False
        and status.get("authorization_request_record_execution_authorization_request_record_execution_requested") is False
        and status.get("authorization_request_record_execution_authorization_request_record_executed") is False
    )
    ...
    if review.get("record_preflight_target") != PREFLIGHT_TARGET:
        review_blockers.append("record_preflight_target_not_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record")
    ...
    false_inputs = {
        "authorization_request_record_execution_authorization_request_record_execution_authorization_request_recorded": "authorization_request_record_execution_authorization_request_record_recorded_must_be_false_in_preflight",
        "authorization_request_record_execution_authorization_request_record_execution_authorized": "record_execution_authorization_grant_must_be_false_in_preflight",
        "authorization_request_record_execution_authorization_request_record_execution_requested": "record_execution_request_must_be_false_in_preflight",
        "authorization_request_record_execution_authorization_request_record_executed": "record_execution_must_be_false_in_preflight",
        "authorization_request_record_execution_authorization_request_recorded": "authorization_request_record_recorded_must_be_false_in_preflight",
    ...
    decision = "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_ready_not_recorded" if ready else "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_blocked_not_recorded"
    payload = {
        ...
        "decision": decision,
        "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_ready": ready,
        ...
        "warnings": [
            "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_status_is_informational_only",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build broker-free Pre-Armed Dry Run authorization request record execution authorization request record execution authorization request record preflight/status from S70 JSON.")
...
def main() -> int:
    ...
    try:
        ...
        payload = build_pre_armed_dry_run_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_status(record_execution_authorization_request_status=status, record_execution_authorization_request_record_preflight_review=review)
