# path: ./tools/test_phase4a_prediction_system_ps_q21a_warroom_prediction_display_auto_refresh_close_guard.py
# desc: Close guard for PS-Q21A WarRoom prediction display auto-refresh.
...
from tools.test_phase4a_prediction_system_ps_q21a_warroom_prediction_display_auto_refresh import (  # noqa: E402
    FALSE_BOUNDARIES,
    REQUIRED_MARKERS,
    SPEC,
)
...
EXPECTED_DIRTY = {
    ...
    "docs/strategy/PREDICTION_SYSTEM_PS_Q21A_WARROOM_PREDICTION_DISPLAY_AUTO_REFRESH_2026-06-26.md",
    "tools/test_phase4a_prediction_system_ps_q21a_warroom_prediction_display_auto_refresh.py",
    "tools/test_phase4a_prediction_system_ps_q21a_warroom_prediction_display_auto_refresh_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        "ok": not failures,
        "guard": "ps_q21a_warroom_prediction_display_auto_refresh_close_guard",
        "contract": {
...
def test_ps_q21a_close_guard() -> None:
    assert main_guard() == 0
