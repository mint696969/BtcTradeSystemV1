# path: ./tools/run_sr_fx_pre_armed_dry_run_authorization_request_status.py
# desc: Broker-free Pre-Armed Dry Run authorization request/status from S77 execution gate. Request/status only; non-recording; non-executing; non-authorizing.
...
TOOL = "run_sr_fx_pre_armed_dry_run_authorization_request_status"
REPORT_VERSION = "pre_armed_dry_run_authorization_request_status.s78.v1"
AUTHORIZATION_SCOPE = "PRE_ARMED_DRY_RUN_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_REVIEW_ONLY"
AUTHORIZATION_TARGET = "APPROVAL_RECORD_APPEND_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION_AUTHORIZATION_REQUEST_RECORD_EXECUTION"
REQUIRED_AUTHORIZATION_ACKS = (
    "confirm_s77_record_execution_gate_dry_run_status_reviewed",
...
FALSE_FIELDS = (
    "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_requested",
    "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorized",
...
def build_pre_armed_dry_run_authorization_request_status(*, record_execution_gate_status: Mapping[str, Any], record_execution_authorization_request: Mapping[str, Any], generated_at: str | None = None) -> dict[str, Any]:
    gate = dict(record_execution_gate_status)
    request = dict(record_execution_authorization_request)
    gate_ok = gate.get("ok") is True
    gate_ready = gate.get("authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_gate_ready") is True
    gate_blockers = _as_list(gate.get("record_execution_gate_blockers"))
    draft = _as_dict(gate.get("authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_draft"))
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build broker-free Pre-Armed Dry Run authorization request/status from S77 gate JSON.")
...
def main() -> int:
    ...
    try:
        ...
        payload = build_pre_armed_dry_run_authorization_request_status(record_execution_gate_status=gate, record_execution_authorization_request=request)
        ...
        for name in FALSE_FIELDS:
            payload[name] = False
        payload["authorization_request_record_execution_authorized"] = False
        payload["authorization_request_record_execution_requested"] = False
        payload["authorization_request_record_executed"] = False
    if args.out:
