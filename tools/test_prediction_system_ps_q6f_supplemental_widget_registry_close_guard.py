# path: ./tools/test_prediction_system_ps_q6f_supplemental_widget_registry_close_guard.py
# desc: Close guard for PS-Q6F supplemental widget registry.
...
TOUCHED = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q6f_supplemental_widget_registry_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q6f_supplemental_widget_registry_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q6F supplemental widget registry close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q6F supplemental widget registry close guard")
    return 0


def test_prediction_system_ps_q6f_supplemental_widget_registry_close_guard() -> None:
    assert main() == 0
