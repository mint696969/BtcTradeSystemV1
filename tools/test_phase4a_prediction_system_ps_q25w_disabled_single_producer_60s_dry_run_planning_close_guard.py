# path: ./tools/test_phase4a_prediction_system_ps_q25w_disabled_single_producer_60s_dry_run_planning_close_guard.py
# desc: Close guard for PS-Q25W disabled single-producer 60s dry-run planning.
...
EXPECTED_DIRTY = {
    ...
    "btcts_next/src/btcts/apps/operator_ui/tests/test_prediction_warroom_single_producer_60s_disabled_dry_run_planning_packet.py",
    "docs/strategy/PREDICTION_SYSTEM_PS_Q25W_DISABLED_SINGLE_PRODUCER_60S_DRY_RUN_PLANNING_2026-06-30.md",
    "tools/diagnose_phase4a_prediction_system_ps_q25w_disabled_single_producer_60s_dry_run_planning.py",
    "tools/test_phase4a_prediction_system_ps_q25w_disabled_single_producer_60s_dry_run_planning.py",
    "tools/test_phase4a_prediction_system_ps_q25w_disabled_single_producer_60s_dry_run_planning_close_guard.py",
}
