# path: ./tools/test_prediction_system_ps_q3b_profile_family_source_caps_close_guard.py
# desc: Close guard for PS-Q3B profile/family-specific source caps.
...
TOUCHED = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q3b_profile_family_source_caps_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q3b_profile_family_source_caps_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q3B profile/family source caps close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q3B profile/family source caps close guard")
    return 0


def test_prediction_system_ps_q3b_profile_family_source_caps_close_guard() -> None:
    assert main() == 0
