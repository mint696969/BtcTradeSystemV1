# path: ./tools/test_prediction_system_ps_q6c_loader_dry_run_simulator_close_guard.py
# desc: Close guard for PS-Q6C latest payload loader dry-run simulator.
...
TOUCHED = (
    REPO_ROOT / "btcts_next/src/btcts/apps/operator_ui/components/prediction_warroom_latest_payload_loader_dry_run_simulator.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q6c_loader_dry_run_simulator_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q6c_loader_dry_run_simulator_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q6c_loader_dry_run_simulator_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q6C loader dry-run simulator close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q6C loader dry-run simulator close guard")
    return 0


def test_prediction_system_ps_q6c_loader_dry_run_simulator_close_guard() -> None:
    assert main() == 0
