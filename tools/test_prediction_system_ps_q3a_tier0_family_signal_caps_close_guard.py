# path: ./tools/test_prediction_system_ps_q3a_tier0_family_signal_caps_close_guard.py
# desc: Close guard for PS-Q3A Tier 0 family output signal caps and contribution ledger.
...
TOUCHED = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q3a_tier0_family_signal_caps_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q3a_tier0_family_signal_caps_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q2d_tier0_source_quality_gate_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q2d_tier0_source_quality_gate_close_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q3A Tier 0 family signal caps close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q3A Tier 0 family signal caps close guard")
    return 0


def test_prediction_system_ps_q3a_tier0_family_signal_caps_close_guard() -> None:
    assert main() == 0
