# path: ./tools/test_prediction_system_ps_q7j_supplemental_handoff_readiness_summary_close_guard.py
# desc: Close guard for PS-Q7J supplemental handoff readiness summary.
...
TOUCHED = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q7j_supplemental_handoff_readiness_summary_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q7j_supplemental_handoff_readiness_summary_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q7J supplemental handoff readiness summary close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q7J supplemental handoff readiness summary close guard")
    return 0


def test_prediction_system_ps_q7j_supplemental_handoff_readiness_summary_close_guard() -> None:
    assert main() == 0
