...
TOOL = "run_sr_fx_pre_armed_dry_run_approval_record_append_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_status"
REPORT_VERSION = "pre_armed_dry_run_approval_record_append_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_status.v1"
...
REQUIRED_PLAN_ACKS = (
    "confirm_s75_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_status_reviewed",
...
def build_pre_armed_dry_run_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_status(*, record_preflight_status: Mapping[str, Any], record_dry_run_plan_review: Mapping[str, Any], generated_at: str | None = None) -> dict[str, Any]:
    preflight = dict(record_preflight_status)
    review = dict(record_dry_run_plan_review)
    preflight_ok = preflight.get("ok") is True
    preflight_ready = preflight.get("authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_preflight_ready") is True
    record_request_observed = preflight.get("record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_recording_requested_observed") is True
    preflight_blockers = _as_list(preflight.get("record_execution_authorization_request_record_execution_authorization_request_record_preflight_blockers"))
    draft = _as_dict(preflight.get("authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_draft"))
    ...
    if review.get("record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_requested") is not True:
        review_blockers.append("record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_request_required")
    ...
    if review.get("record_dry_run_plan_target") != PLAN_TARGET:
        review_blockers.append("record_dry_run_plan_target_not_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_plan")
    ...
    false_inputs = {
        "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_recorded": "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_recorded_must_be_false_in_plan",
        "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorized": "record_execution_authorization_grant_must_be_false_in_plan",
        "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_requested": "record_execution_request_must_be_false_in_plan",
        "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_executed": "record_execution_must_be_false_in_plan",
        "authorization_request_record_execution_authorization_request_record_execution_authorization_request_recorded": "authorization_request_record_recorded_must_be_false_in_plan",
    ...
    review_blockers.extend(f"missing_record_execution_authorization_request_record_execution_authorization_request_record_plan_ack:{ack}" for ack in missing_acks)

    plan_blockers: list[str] = []
    if not preflight_ok:
        plan_blockers.append("record_execution_authorization_request_record_execution_authorization_request_record_preflight_status_not_ok")
    if not preflight_ready:
        plan_blockers.append("record_execution_authorization_request_record_execution_authorization_request_record_preflight_not_ready")
        plan_blockers.extend(preflight_blockers)
    if not record_request_observed:
        plan_blockers.append("record_execution_authorization_request_record_execution_authorization_request_recording_request_not_observed")
    if not preflight_safety_ok:
        plan_blockers.append("record_execution_authorization_request_record_execution_authorization_request_record_preflight_safety_contract_not_clear")
    if draft.get("recorded") is not False or draft.get("authorized") is not False or draft.get("executed") is not False:
        plan_blockers.append("authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_draft_not_dry_run_safe")
    ...
    payload = {
        ...
        "decision": decision,
        "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_ready": ready,
        "record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_blockers": plan_blockers,
        "record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_requested_observed": review.get("record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_requested") is True,
        "read_only": True,
        ...
        "warnings": [
            "authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_status_is_informational_only",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build broker-free Pre-Armed Dry Run authorization request record execution authorization request record execution authorization request record dry-run plan/status from S75 JSON.")
...
def main() -> int:
    ...
    try:
        ...
        payload = build_pre_armed_dry_run_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_execution_authorization_request_record_dry_run_plan_status(record_preflight_status=preflight, record_dry_run_plan_review=review)
