# path: ./tools/test_prediction_system_ps_q7l_readiness_widget_registry_registration_close_guard.py
# desc: Close guard for PS-Q7L readiness widget registry registration.
...
TOUCHED = (
    ...
    REPO_ROOT / "btcts_next/src/btcts/apps/operator_ui/components/prediction_warroom_authorization_handoff_status_catalog.py",
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q7l_readiness_widget_registry_registration_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q7l_readiness_widget_registry_registration_guard.py",
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q7i_authorization_handoff_status_registry_registration_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7h_authorization_handoff_status_widget_group_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7g_authorization_handoff_status_catalog_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7f_summary_widget_registry_registration_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7e_authorization_registry_summary_widget_group_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7d_authorization_registry_summary_panel_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7c_authorization_registry_registration_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7b_loader_authorization_widget_group_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7a_loader_authorization_request_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q6i_handoff_catalog_visibility_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q6h_supplemental_handoff_bundle_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q6g_supplemental_registry_preflight_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q6f_supplemental_widget_registry_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q6e_dry_run_widget_group_index_guard.py",
...
PROTECTED_PREFIXES = ("btcts_next/src/btcts/collector_vnext/", "btcts_next/src/btcts/autotrade/")
...
def main() -> int:
    ...
    failures.extend(f"protected collector/autotrade dirty: {line}" for line in proc.stdout.splitlines() if any(prefix in line for prefix in PROTECTED_PREFIXES))
    if failures:
        print("[FAIL] Prediction System PS-Q7L readiness widget registry registration close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q7L readiness widget registry registration close guard")
    return 0


def test_prediction_system_ps_q7l_readiness_widget_registry_registration_close_guard() -> None:
    assert main() == 0
