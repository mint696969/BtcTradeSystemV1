# path: ./tools/test_prediction_system_ps_q3c_signal_strength_bands_close_guard.py
# desc: Close guard for PS-Q3C signal strength band summaries.
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q3C signal strength bands close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q3C signal strength bands close guard")
    return 0


def test_prediction_system_ps_q3c_signal_strength_bands_close_guard() -> None:
    assert main() == 0
