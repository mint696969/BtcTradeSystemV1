# path: ./tools/test_prediction_system_ps_q9l_prediction_compact_summary_card_close_guard.py
# desc: Close guard for PS-Q9L compact prediction summary card in review panel.
...
TOUCHED = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q9l_prediction_compact_summary_card_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q9l_prediction_compact_summary_card_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q9L compact prediction summary card close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q9L compact prediction summary card close guard")
    return 0


def test_prediction_system_ps_q9l_prediction_compact_summary_card_close_guard() -> None:
    assert main() == 0
