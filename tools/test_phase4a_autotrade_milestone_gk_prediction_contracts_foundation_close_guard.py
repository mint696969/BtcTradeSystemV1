# path: ./tools/test_phase4a_autotrade_milestone_gk_prediction_contracts_foundation_close_guard.py
# desc: Close guard for S122 prediction contracts foundation. Syntax-checks touched files and reruns focused GK guard.
...
TOUCHED = (
    ...
    REPO_ROOT / "btcts_next/src/btcts/prediction/horizons.py",
    REPO_ROOT / "btcts_next/src/btcts/prediction/contracts.py",
    REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gk_prediction_contracts_foundation_guard.py",
    REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gk_prediction_contracts_foundation_close_guard.py",
)
GUARD = REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gk_prediction_contracts_foundation_guard.py"
...
def main() -> int:
    ...
    if guard_proc.returncode != 0 or guard_payload.get("ok") is not True:
        failures.append("focused GK prediction contracts foundation guard did not close")
    payload = {
        "ok": not failures,
        "phase": "phase4a_autotrade_milestone_gk_prediction_contracts_foundation_close_guard",
