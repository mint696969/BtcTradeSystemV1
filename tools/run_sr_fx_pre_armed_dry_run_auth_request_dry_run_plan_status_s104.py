# path: ./tools/run_sr_fx_pre_armed_dry_run_auth_request_dry_run_plan_status_s104.py
# desc: Broker-free Pre-Armed Dry Run authorization request dry-run plan/status from S103 preflight/status. Plan/status only; non-recording; non-executing; non-authorizing. Short path avoids Windows MAX_PATH.
...
TOOL = "run_sr_fx_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_dry_run_plan_status"
REPORT_VERSION = "pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_dry_run_plan_status.s104.v1"
...
REQUIRED_PLAN_ACKS = (
    "confirm_s103_authorization_request_preflight_status_reviewed",
...
def build_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_dry_run_plan_status(*, authorization_request_preflight_status: Mapping[str, Any], authorization_request_dry_run_plan_review: Mapping[str, Any], generated_at: str | None = None) -> dict[str, Any]:
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build broker-free Pre-Armed Dry Run authorization request dry-run plan/status from S103 preflight JSON.")
...
def main() -> int:
    ...
    try:
        ...
        payload = build_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_dry_run_plan_status(authorization_request_preflight_status=preflight, authorization_request_dry_run_plan_review=review)
