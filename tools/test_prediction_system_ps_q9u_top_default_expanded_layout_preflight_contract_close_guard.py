# path: ./tools/test_prediction_system_ps_q9u_top_default_expanded_layout_preflight_contract_close_guard.py
# desc: Close guard for PS-Q9U top/default-expanded layout preflight contract.
...
TOUCHED = (
    REPO_ROOT / "btcts_next/src/btcts/apps/operator_ui/components/prediction_warroom_top_default_expanded_layout_preflight_contract.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q9u_top_default_expanded_layout_preflight_contract_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q9u_top_default_expanded_layout_preflight_contract_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q9u_top_default_expanded_layout_preflight_contract_guard.py",
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q9m_future_top_ux_readiness_gate_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q9l_prediction_compact_summary_card_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q9k_review_panel_operator_readability_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q9U top/default-expanded layout preflight contract close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q9U top/default-expanded layout preflight contract close guard")
    return 0


def test_prediction_system_ps_q9u_top_default_expanded_layout_preflight_contract_close_guard() -> None:
    assert main() == 0
