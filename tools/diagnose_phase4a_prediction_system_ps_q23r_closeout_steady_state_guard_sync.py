...
ALLOWED_ROOM_GATES = {EXPECTED_PRE_CLOSEOUT_GATE, EXPECTED_POST_CLOSEOUT_GATE, EXPECTED_Q23T_GATE, EXPECTED_Q24A_GATE, EXPECTED_Q24B_GATE, EXPECTED_Q24C_GATE, EXPECTED_Q24D_GATE, EXPECTED_Q24E_GATE, EXPECTED_Q24F_GATE, EXPECTED_Q24G_GATE, EXPECTED_Q24H_GATE}
ALLOWED_ROOM_FOCUSES = {EXPECTED_PRE_CLOSEOUT_FOCUS, EXPECTED_POST_CLOSEOUT_FOCUS, EXPECTED_Q23T_FOCUS, EXPECTED_Q24A_FOCUS, EXPECTED_Q24B_FOCUS, EXPECTED_Q24C_FOCUS, EXPECTED_Q24D_FOCUS, EXPECTED_Q24E_FOCUS, EXPECTED_Q24F_FOCUS, EXPECTED_Q24G_FOCUS, EXPECTED_Q24H_FOCUS}
ALLOWED_ROOM_SLICES = {EXPECTED_PRE_CLOSEOUT_SLICE, EXPECTED_POST_CLOSEOUT_SLICE, EXPECTED_Q23T_SLICE, EXPECTED_Q24A_SLICE, EXPECTED_Q24B_SLICE, EXPECTED_Q24C_SLICE, EXPECTED_Q24D_SLICE, EXPECTED_Q24E_SLICE, EXPECTED_Q24F_SLICE, EXPECTED_Q24G_SLICE, EXPECTED_Q24H_SLICE}
DIRTY_ONLY_BLOCKERS = {
...
def run_ps_q23r_closeout_steady_state_guard_sync() -> dict[str, Any]:
    ...
    if not (status_has_pre_closeout_marker or status_has_post_closeout_marker or status_has_q23t_marker or status_has_q24a_marker or status_has_q24b_marker or status_has_q24c_marker or status_has_q24d_marker or status_has_q24e_marker or status_has_q24f_marker or status_has_q24g_marker or status_has_q24h_marker):
    ...
    return {
        ...
        "room": {
            "status_marker_present": status_has_pre_closeout_marker or status_has_post_closeout_marker or status_has_q23t_marker or status_has_q24a_marker or status_has_q24b_marker or status_has_q24c_marker or status_has_q24d_marker or status_has_q24e_marker or status_has_q24f_marker or status_has_q24g_marker or status_has_q24h_marker,
