# path: ./tools/test_phase4a_prediction_system_ps_q24l_autotrade_read_only_status_page_actual_page_wiring_explicit_human_gate_required_close_guard.py
# desc: Close guard for PS-Q24L explicit human gate required with page wiring still blocked.
...
EXPECTED_DIRTY = {
    ...
    "docs/strategy/PREDICTION_SYSTEM_PS_Q24L_AUTOTRADE_READ_ONLY_STATUS_PAGE_ACTUAL_PAGE_WIRING_EXPLICIT_HUMAN_GATE_REQUIRED_2026-06-29.md",
    "tools/diagnose_phase4a_prediction_system_ps_q23r_closeout_steady_state_guard_sync.py",
    "tools/diagnose_phase4a_prediction_system_ps_q24l_autotrade_read_only_status_page_actual_page_wiring_explicit_human_gate_required.py",
    "tools/test_phase4a_prediction_system_ps_q24l_autotrade_read_only_status_page_actual_page_wiring_explicit_human_gate_required.py",
    "tools/test_phase4a_prediction_system_ps_q24l_autotrade_read_only_status_page_actual_page_wiring_explicit_human_gate_required_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        ...
        "guard": "ps_q24l_autotrade_read_only_status_page_actual_page_wiring_explicit_human_gate_required_close_guard",
