# path: ./tools/run_sr_fx_pre_armed_dry_run_auth_request_preflight_status_s111.py
# desc: Broker-free Pre-Armed Dry Run authorization request preflight/status from S110 authorization request/status. Preflight/status only; non-recording; non-executing; non-authorizing. Short path avoids Windows MAX_PATH.
...
TOOL = "run_sr_fx_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_preflight_status"
REPORT_VERSION = "pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_preflight_status.s111.v1"
...
REQUIRED_PREFLIGHT_ACKS = (
    "confirm_s110_authorization_request_status_reviewed",
...
def build_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_preflight_status(*, authorization_request_status: Mapping[str, Any], authorization_request_preflight_review: Mapping[str, Any], generated_at: str | None = None) -> dict[str, Any]:
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build broker-free Pre-Armed Dry Run authorization request preflight/status from S110 status JSON.")
...
def main() -> int:
    ...
    try:
        ...
        payload = build_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_execution_authorization_request_preflight_status(authorization_request_status=status, authorization_request_preflight_review=review)
