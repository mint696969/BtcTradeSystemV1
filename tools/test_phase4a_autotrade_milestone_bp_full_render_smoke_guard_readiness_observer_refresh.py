# path: ./tools/test_phase4a_autotrade_milestone_bp_full_render_smoke_guard_readiness_observer_refresh.py
# desc: Full AutoTrade tab render smoke after readiness observer blocked visibility. No command/mode/observer append; no runner/broker.
...
def main() -> int:
    ...
    failures.extend(f"protected lower-layer dirty during milestone BP: {hit}" for hit in protected_dirty_hits)

    payload = {
        "ok": not failures,
        "phase": "phase4a_autotrade_milestone_bp_full_render_smoke_guard_readiness_observer_refresh",
