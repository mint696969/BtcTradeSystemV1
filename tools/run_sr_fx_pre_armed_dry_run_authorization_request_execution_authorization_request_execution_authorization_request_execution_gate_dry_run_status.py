# path: ./tools/run_sr_fx_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_gate_dry_run_status.py
# desc: Broker-free Pre-Armed Dry Run authorization request execution gate dry-run/status from S88 plan/status. Gate/status only; non-recording; non-executing; non-authorizing.
...
TOOL = "run_sr_fx_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_gate_dry_run_status"
REPORT_VERSION = "pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_gate_dry_run_status.s89.v1"
REQUIRED_GATE_ACKS = (
    "confirm_s88_authorization_request_dry_run_plan_status_reviewed",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build broker-free Pre-Armed Dry Run authorization request execution gate dry-run/status from S88 plan JSON.")
...
def main() -> int:
    ...
    try:
        ...
        payload = build_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_execution_gate_dry_run_status(authorization_request_dry_run_plan_status=plan, authorization_request_execution_gate_review=review)
