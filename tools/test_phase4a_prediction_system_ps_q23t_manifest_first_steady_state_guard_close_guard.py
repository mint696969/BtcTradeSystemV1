# path: ./tools/test_phase4a_prediction_system_ps_q23t_manifest_first_steady_state_guard_close_guard.py
# desc: Close guard for PS-Q23T manifest-first steady-state guard hardening slice.
...
EXPECTED_DIRTY = {
    "docs/strategy/PREDICTION_SYSTEM_PS_Q23T_MANIFEST_FIRST_STEADY_STATE_GUARD_HARDENING_2026-06-29.md",
    "tools/diagnose_phase4a_prediction_system_ps_q23r_closeout_steady_state_guard_sync.py",
    "tools/diagnose_phase4a_prediction_system_ps_q23t_manifest_first_steady_state_guard.py",
    "tools/test_phase4a_prediction_system_ps_q23r_closeout_steady_state_guard_sync.py",
    "tools/test_phase4a_prediction_system_ps_q23t_manifest_first_steady_state_guard.py",
    "tools/test_phase4a_prediction_system_ps_q23t_manifest_first_steady_state_guard_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        ...
        "guard": "ps_q23t_manifest_first_steady_state_guard_close_guard",
