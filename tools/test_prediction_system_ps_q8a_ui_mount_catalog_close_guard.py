# path: ./tools/test_prediction_system_ps_q8a_ui_mount_catalog_close_guard.py
# desc: Close guard for PS-Q8A Prediction WarRoom UI mount catalog.
...
TOUCHED = (
    REPO_ROOT / "btcts_next/src/btcts/apps/operator_ui/components/prediction_warroom_ui_mount_catalog.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q8a_ui_mount_catalog_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q8a_ui_mount_catalog_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q8a_ui_mount_catalog_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q8A UI mount catalog close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q8A UI mount catalog close guard")
    return 0


def test_prediction_system_ps_q8a_ui_mount_catalog_close_guard() -> None:
    assert main() == 0
