# path: ./tools/test_phase4a_autotrade_milestone_gq_rule_based_v0_close_guard.py
# desc: Close guard for S128 rule-based v0 prediction outputs. Syntax-checks touched files and reruns focused GQ guard.
...
TOUCHED = (
    ...
    REPO_ROOT / "btcts_next/src/btcts/prediction/rule_based_v0.py",
    REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gq_rule_based_v0_guard.py",
    REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gq_rule_based_v0_close_guard.py",
)
GUARD = REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gq_rule_based_v0_guard.py"
...
def main() -> int:
    ...
    if guard_proc.returncode != 0 or guard_payload.get("ok") is not True:
        failures.append("focused GQ rule-based v0 guard did not close")
    payload = {
        "ok": not failures,
        "phase": "phase4a_autotrade_milestone_gq_rule_based_v0_close_guard",
