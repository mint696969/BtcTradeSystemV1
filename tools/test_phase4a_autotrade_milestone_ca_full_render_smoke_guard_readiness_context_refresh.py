# path: ./tools/test_phase4a_autotrade_milestone_ca_full_render_smoke_guard_readiness_context_refresh.py
# desc: Full AutoTrade tab render smoke after readiness context visibility. No command/mode/observer append; no runner/broker.
...
def main() -> int:
    ...
    failures.extend(f"protected lower-layer dirty during milestone CA: {hit}" for hit in protected_dirty_hits)

    payload = {
        "ok": not failures,
        "phase": "phase4a_autotrade_milestone_ca_full_render_smoke_guard_readiness_context_refresh",
