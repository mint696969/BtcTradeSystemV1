# path: ./tools/test_phase4a_autotrade_milestone_by_full_render_smoke_guard_mode_change_note_filter_refresh.py
# desc: Full AutoTrade tab render smoke after mode-change note command-type filter. No command/mode/observer append; no runner/broker.
    ...
    return {
        ...
        "command": {
            ...
            "note": json.dumps({
                ...
                "warnings": ["full_render_command_note_visibility_refresh"],
                "health_state": "warn",
...
def main() -> int:
    ...
    failures.extend(f"protected lower-layer dirty during milestone BY: {hit}" for hit in protected_dirty_hits)

    payload = {
        "ok": not failures,
        "phase": "phase4a_autotrade_milestone_by_full_render_smoke_guard_mode_change_note_filter_refresh",
