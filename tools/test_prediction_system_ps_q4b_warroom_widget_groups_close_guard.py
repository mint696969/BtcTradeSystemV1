# path: ./tools/test_prediction_system_ps_q4b_warroom_widget_groups_close_guard.py
# desc: Close guard for PS-Q4B WarRoom widget group packets.
...
TOUCHED = (
    REPO_ROOT / "btcts_next/src/btcts/apps/operator_ui/components/prediction_warroom_widget_groups.py",
...
GUARDS = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q4a_warroom_display_packet_close_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q4B WarRoom widget groups close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q4B WarRoom widget groups close guard")
    return 0


def test_prediction_system_ps_q4b_warroom_widget_groups_close_guard() -> None:
    assert main() == 0
