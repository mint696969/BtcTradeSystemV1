# path: ./tools/test_phase4a_autotrade_milestone_go_human_technical_indicators_close_guard.py
# desc: Close guard for S126 human technical indicators. Syntax-checks touched files and reruns focused GO guard.
...
TOUCHED = (
    ...
    REPO_ROOT / "btcts_next/src/btcts/prediction/technical.py",
    REPO_ROOT / "tools/test_phase4a_autotrade_milestone_go_human_technical_indicators_guard.py",
    REPO_ROOT / "tools/test_phase4a_autotrade_milestone_go_human_technical_indicators_close_guard.py",
)
GUARD = REPO_ROOT / "tools/test_phase4a_autotrade_milestone_go_human_technical_indicators_guard.py"
...
def main() -> int:
    ...
    if guard_proc.returncode != 0 or guard_payload.get("ok") is not True:
        failures.append("focused GO human technical indicators guard did not close")
    payload = {
        "ok": not failures,
        "phase": "phase4a_autotrade_milestone_go_human_technical_indicators_close_guard",
