# path: ./tools/test_prediction_system_ps_q6i_handoff_catalog_visibility_close_guard.py
# desc: Close guard for PS-Q6I handoff catalog visibility contract.
...
TOUCHED = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q6i_handoff_catalog_visibility_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q6i_handoff_catalog_visibility_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q6I handoff catalog visibility close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q6I handoff catalog visibility close guard")
    return 0


def test_prediction_system_ps_q6i_handoff_catalog_visibility_close_guard() -> None:
    assert main() == 0
