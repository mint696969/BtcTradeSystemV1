# path: ./tools/test_prediction_system_ps_q10a_source_mapping_preflight_contract_close_guard.py
# desc: Close guard for PS-Q10A source mapping preflight contract.
...
TOUCHED = (
    REPO_ROOT / "btcts_next/src/btcts/apps/operator_ui/components/prediction_warroom_source_mapping_preflight_contract.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q10a_source_mapping_preflight_contract_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q10a_source_mapping_preflight_contract_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q10a_source_mapping_preflight_contract_guard.py",
...
PROTECTED_PREFIXES = (
    ...
    "btcts_next/src/btcts/apps/operator_ui/components/prediction_warroom_hot_source_probe.py",
)
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q10A source mapping preflight contract close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q10A source mapping preflight contract close guard")
    return 0


def test_prediction_system_ps_q10a_source_mapping_preflight_contract_close_guard() -> None:
    assert main() == 0
