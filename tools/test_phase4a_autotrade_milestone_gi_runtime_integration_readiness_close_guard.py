# path: ./tools/test_phase4a_autotrade_milestone_gi_runtime_integration_readiness_close_guard.py
# desc: Close guard for S120 runtime integration readiness. Syntax-checks touched files and reruns focused GI guard.
...
GUARD = REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gi_runtime_integration_readiness_guard.py"
SELF = REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gi_runtime_integration_readiness_close_guard.py"
...
def main() -> int:
    ...
    if guard_proc.returncode != 0 or guard_payload.get("ok") is not True:
        failures.append("focused GI runtime integration readiness guard did not close")
    payload = {
        "ok": not failures,
        "phase": "phase4a_autotrade_milestone_gi_runtime_integration_readiness_close_guard",
