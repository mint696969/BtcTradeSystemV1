# path: ./tools/test_phase4a_autotrade_milestone_gx_prearmed_readiness_close_guard.py
# desc: Close guard for S135 Pre-Armed readiness contract. Syntax-checks touched files and reruns focused GX guard.
...
TOUCHED = (
    ...
    REPO_ROOT / "btcts_next/src/btcts/prediction/prearmed_readiness.py",
    REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gx_prearmed_readiness_guard.py",
    REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gx_prearmed_readiness_close_guard.py",
)
GUARD = REPO_ROOT / "tools/test_phase4a_autotrade_milestone_gx_prearmed_readiness_guard.py"
...
def main() -> int:
    ...
    if guard_proc.returncode != 0 or guard_payload.get("ok") is not True:
        failures.append("focused GX prearmed readiness guard did not close")
    payload = {
        "ok": not failures,
        "phase": "phase4a_autotrade_milestone_gx_prearmed_readiness_close_guard",
