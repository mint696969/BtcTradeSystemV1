# path: ./tools/run_sr_fx_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_status.py
# desc: Broker-free Pre-Armed Dry Run authorization request/status from S85 execution gate. Request/status only; non-recording; non-executing; non-authorizing.
...
TOOL = "run_sr_fx_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_status"
REPORT_VERSION = "pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_status.s86.v1"
...
REQUIRED_AUTHORIZATION_ACKS = (
    "confirm_s85_authorization_request_execution_gate_status_reviewed",
...
def build_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_status(*, authorization_request_execution_gate_status: Mapping[str, Any], authorization_request_status_request: Mapping[str, Any], generated_at: str | None = None) -> dict[str, Any]:
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build broker-free Pre-Armed Dry Run authorization request/status from S85 gate JSON.")
...
def main() -> int:
    ...
    try:
        ...
        payload = build_pre_armed_dry_run_authorization_request_execution_authorization_request_execution_authorization_request_status(authorization_request_execution_gate_status=gate, authorization_request_status_request=request)
