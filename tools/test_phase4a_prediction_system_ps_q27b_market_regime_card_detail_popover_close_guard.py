# path: ./tools/test_phase4a_prediction_system_ps_q27b_market_regime_card_detail_popover_close_guard.py
# desc: Close guard for PS-Q27B market regime card detail popover.
...
EXPECTED_DIRTY = {
    ...
    "docs/strategy/PREDICTION_SYSTEM_PS_Q27B_MARKET_REGIME_CARD_DETAIL_POPOVER_2026-07-01.md",
    ...
    "tools/test_phase4a_prediction_system_ps_q27b_market_regime_card_detail_popover_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        ...
        "guard": "ps_q27b_market_regime_card_detail_popover_close_guard",
