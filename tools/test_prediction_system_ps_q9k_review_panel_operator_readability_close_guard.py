# path: ./tools/test_prediction_system_ps_q9k_review_panel_operator_readability_close_guard.py
# desc: Close guard for PS-Q9K review panel operator readability.
...
TOUCHED = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q9k_review_panel_operator_readability_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q9k_review_panel_operator_readability_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q9K review panel operator readability close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q9K review panel operator readability close guard")
    return 0


def test_prediction_system_ps_q9k_review_panel_operator_readability_close_guard() -> None:
    assert main() == 0
