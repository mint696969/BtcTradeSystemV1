# path: ./tools/test_phase4a_execution_review_hint_builder_skeleton_guard.py
# desc: Phase 4-A Execution review hint read-only helper skeleton guard.
...
SELF_PATH = "tools/test_phase4a_execution_review_hint_builder_skeleton_guard.py"
CONTRACT_GUARD_PATH = "tools/test_phase4a_execution_review_hint_entry_criteria_guard.py"
BUILDER_PATH = "btcts_next/src/btcts/processing/l4_consumer_models/shared/prediction_execution_review_hint_builder.py"
TEST_PATH = "btcts_next/src/btcts/processing/l4_consumer_models/tests/test_prediction_execution_review_hint_builder.py"
...
def _compile(rel_path: str, failures: list[str]) -> dict[str, Any]:
    ...
    cache = REPO_ROOT / "tmp" / "_guard_py_compile_cache" / "execution_review_hint_builder_skeleton"
...
def _check_source(failures: list[str]) -> dict[str, Any]:
    ...
    for token in forbidden_hits:
        failures.append(f"new Execution helper files contain forbidden token: {token}")
...
def main() -> int:
    ...
    payload = {
        "ok": not failures,
        "phase": "phase4a_execution_review_hint_builder_skeleton_guard",
        "failures": failures,
        "checks": checks,
    }
