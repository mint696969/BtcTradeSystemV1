# path: ./tools/test_phase4a_prediction_system_ps_q27c_market_regime_card_selected_detail_panel_close_guard.py
# desc: Close guard for PS-Q27C market regime card selected-detail panel.
...
EXPECTED_DIRTY = {
    ...
    "tools/diagnose_phase4a_prediction_system_ps_q27b_market_regime_card_detail_popover.py",
    "tools/test_phase4a_prediction_system_ps_q27b_market_regime_card_detail_popover.py",
    "docs/strategy/PREDICTION_SYSTEM_PS_Q27C_MARKET_REGIME_CARD_SELECTED_DETAIL_PANEL_2026-07-01.md",
    "tools/diagnose_phase4a_prediction_system_ps_q27c_market_regime_card_selected_detail_panel.py",
    "tools/test_phase4a_prediction_system_ps_q27c_market_regime_card_selected_detail_panel.py",
    "tools/test_phase4a_prediction_system_ps_q27c_market_regime_card_selected_detail_panel_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        ...
        "guard": "ps_q27c_market_regime_card_selected_detail_panel_close_guard",
