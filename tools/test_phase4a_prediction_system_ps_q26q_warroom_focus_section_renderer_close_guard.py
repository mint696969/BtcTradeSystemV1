# path: ./tools/test_phase4a_prediction_system_ps_q26q_warroom_focus_section_renderer_close_guard.py
# desc: Close guard for PS-Q26Q WarRoom focus section renderer.
...
EXPECTED_DIRTY = {
    ...
    "docs/strategy/PREDICTION_SYSTEM_PS_Q26Q_WARROOM_FOCUS_SECTION_RENDERER_2026-07-01.md",
    ...
    "tools/diagnose_phase4a_prediction_system_ps_q26q_warroom_focus_section_renderer.py",
    "tools/test_phase4a_prediction_system_ps_q26q_warroom_focus_section_renderer.py",
    "tools/test_phase4a_prediction_system_ps_q26q_warroom_focus_section_renderer_close_guard.py",
}
...
def main_guard() -> int:
    ...
    result = {
        ...
        "guard": "ps_q26q_warroom_focus_section_renderer_close_guard",
