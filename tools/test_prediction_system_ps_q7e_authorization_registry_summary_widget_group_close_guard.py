# path: ./tools/test_prediction_system_ps_q7e_authorization_registry_summary_widget_group_close_guard.py
# desc: Close guard for PS-Q7E authorization registry summary widget group.
...
TOUCHED = (
    REPO_ROOT / "btcts_next/src/btcts/apps/operator_ui/components/prediction_warroom_loader_authorization_registry_summary_widget_groups.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7e_authorization_registry_summary_widget_group_guard.py",
    REPO_ROOT / "tools/test_prediction_system_ps_q7e_authorization_registry_summary_widget_group_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q7e_authorization_registry_summary_widget_group_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q7E authorization registry summary widget group close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q7E authorization registry summary widget group close guard")
    return 0


def test_prediction_system_ps_q7e_authorization_registry_summary_widget_group_close_guard() -> None:
    assert main() == 0
