# path: ./tools/test_prediction_system_ps_q7g_authorization_handoff_status_catalog_close_guard.py
# desc: Close guard for PS-Q7G authorization handoff status catalog.
...
TOUCHED = (
    ...
    REPO_ROOT / "tools/test_prediction_system_ps_q7g_authorization_handoff_status_catalog_close_guard.py",
)
GUARDS = (
    REPO_ROOT / "tools/test_prediction_system_ps_q7g_authorization_handoff_status_catalog_guard.py",
...
def main() -> int:
    ...
    if failures:
        print("[FAIL] Prediction System PS-Q7G authorization handoff status catalog close guard")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("[OK] Prediction System PS-Q7G authorization handoff status catalog close guard")
    return 0


def test_prediction_system_ps_q7g_authorization_handoff_status_catalog_close_guard() -> None:
    assert main() == 0
