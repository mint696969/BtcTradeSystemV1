...
def health_digest_status_payload(digest: HealthDigest | None) -> dict[str, Any]:
    ...
    return {
        ...
        "semantic_observability": {
            "summary_source": semantic_usage.get("summary_source"),
            "observer_status": semantic_usage.get("observer_status"),
            "observer_present": bool(semantic_usage.get("observer_present")),
            "usage_summary_present": bool(semantic_usage.get("usage_summary_present")),
            "runtime_wiring_status": semantic_usage.get("runtime_wiring_status"),
            "contract_rows_present": bool(semantic_usage.get("contract_rows_present")),
            "contract_rows_kind": "event_family_contract_rows",
            "contract_rows_count": _number(semantic_usage.get("contract_rows_count")),
            "contract_rows": semantic_contract_rows,
            "source_series_present": bool(semantic_usage.get("source_series_present")),
        },
        "orderbook_active_event_observability": {
            "contract_status_source": orderbook_runtime.get("contract_status_source"),
            "runtime_wiring_status": orderbook_runtime.get("wiring_status"),
            "near_wall_present": bool(orderbook_runtime.get("near_wall_present")),
            "support_present": bool(orderbook_runtime.get("support_present")),
            "resistance_present": bool(orderbook_runtime.get("resistance_present")),
            "persistence_present": bool(orderbook_runtime.get("persistence_present")),
            "persistence_observable": bool(orderbook_runtime.get("persistence_observable")),
            "summary_slots_kind": "summary_slot_names",
            "summary_slots_count": _number(orderbook_runtime.get("summary_slots_count")),
