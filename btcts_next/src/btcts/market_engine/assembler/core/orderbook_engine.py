# path: ./btcts_next/src/btcts/market_engine/assembler/core/orderbook_engine.py
# desc: Generic orderbook assembly engine that applies anchors and diffs through exchange profile policy.
