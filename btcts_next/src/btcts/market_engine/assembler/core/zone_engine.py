# path: ./btcts_next/src/btcts/market_engine/assembler/core/zone_engine.py
# desc: Hybrid near/far zone engine for Market Engine book outputs and density metadata.
