# path: ./btcts_next/src/btcts/market_engine/assembler/core/series_engine.py
# desc: Deterministic series segmentation engine for normalized_capture streams and boundary events.
