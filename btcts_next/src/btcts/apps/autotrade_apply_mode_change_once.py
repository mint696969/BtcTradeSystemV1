# path: ./btcts_next/src/btcts/apps/autotrade_apply_mode_change_once.py
# desc: Default CLI entry for one-shot mode-change command applier. Uses readiness recheck; mode-state ledger only; no broker execution.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Apply latest accepted AutoTrade REQUEST_MODE_CHANGE with readiness recheck to mode_state ledger once.")
