    ...
    _render_json(
        {
            ...
            "candidate_readiness_parameter_bundle_runtime": data.get("candidate_readiness_parameter_bundle_runtime"),
    ...
    _render_json(
        {
            ...
            "latest_readiness_parameter_bundle_runtime": data.get("latest_readiness_parameter_bundle_runtime"),
            ...
            "latest_mode_change_readiness_parameter_bundle_runtime": data.get("latest_mode_change_readiness_parameter_bundle_runtime"),
