...
from btcts.apps.operator_ui.prediction_warroom.v2.transport import (
    ...
    WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_VISIBLE_MOUNT_GATE_OBSERVATION_STATE_KEY,
    WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_RENDERER_OBSERVATION_STATE_KEY,
    WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_ACTUAL_MOUNT_GATE_OBSERVATION_STATE_KEY,
    WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_ADAPTER_OBSERVATION_STATE_KEY,
    WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_MOUNT_GATE_OBSERVATION_STATE_KEY,
    ...
    build_warroom_v2_compact_ws_status_line_streamlit_visible_mount_gate_observation_packet,
...
from btcts.apps.operator_ui.prediction_warroom.v2.transport.ws_receiver_only_client_page_mount_path_hidden_observation import (
    WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_PAGE_MOUNT_PATH_HIDDEN_OBSERVATION_STATE_KEY,
    WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_PAGE_MOUNT_PATH_OPERATOR_ACK_STATE_KEY,
    WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_PAGE_MOUNT_PATH_REQUEST_STATE_KEY,
...
def _render_warroom_v2_top_minimal_status_line_mount_q32y() -> None:
    q32x_packet = st.session_state.get(WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_MOUNT_GATE_OBSERVATION_STATE_KEY)
    mount_point_packet = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_mount_point_packet(
        visible_render_mount_gate_observation_packet=q32x_packet if isinstance(q32x_packet, dict) else None,
        visible_mount_point_requested=bool(st.session_state.get(WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_MOUNT_POINT_REQUEST_STATE_KEY, False)),
        operator_visible_mount_point_ack=bool(st.session_state.get(WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_MOUNT_POINT_OPERATOR_ACK_STATE_KEY, False)),
    )
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_MOUNT_POINT_STATE_KEY] = mount_point_packet
...
def _record_warroom_v2_transport_shadow_integration_state(*, fragment_enabled: bool, prediction_fragment_enabled: bool) -> None:
    ...
    # Hidden session_state key: warroom_v2_ws_receiver_only_client_session_state_apply_hidden_record_q33g
    st.session_state[WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_SESSION_STATE_APPLY_HIDDEN_RECORD_KEY] = build_warroom_v2_ws_receiver_only_client_session_state_apply_hidden_record_packet(
        fragment_summary=fragment_summary,
    )
    # Hidden session_state key: warroom_v2_ws_receiver_only_client_lightweight_state_target_write_hidden_record_q33j
    st.session_state[WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_LIGHTWEIGHT_STATE_TARGET_WRITE_HIDDEN_RECORD_KEY] = build_warroom_v2_ws_receiver_only_client_lightweight_state_target_write_hidden_record_packet(
        fragment_summary=fragment_summary,
    )
    ...
    # Hidden session_state key: warroom_v2_compact_ws_status_line_gate_observation_q32f
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_GATE_OBSERVATION_STATE_KEY] = build_warroom_v2_compact_ws_status_line_gate_observation_packet(
        fragment_summary=fragment_summary,
        messages=[],
        render_requested=False,
        operator_read_only_ack=False,
    )
    # Hidden session_state key: warroom_v2_compact_ws_status_line_visible_mount_gate_observation_q32h
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_VISIBLE_MOUNT_GATE_OBSERVATION_STATE_KEY] = build_warroom_v2_compact_ws_status_line_visible_mount_gate_observation_packet(
        fragment_summary=fragment_summary,
        messages=[],
    ...
    # Hidden session_state key: warroom_v2_compact_ws_status_line_visible_render_adapter_observation_q32j
    ...
    # Hidden session_state key: warroom_v2_compact_ws_status_line_streamlit_minimal_renderer_observation_q32n
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_MINIMAL_RENDERER_OBSERVATION_STATE_KEY] = build_warroom_v2_compact_ws_status_line_streamlit_minimal_renderer_observation_packet(
        fragment_summary=fragment_summary,
        messages=[],
    ...
    # Hidden session_state key: warroom_v2_compact_ws_status_line_streamlit_visible_mount_gate_observation_q32p
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_VISIBLE_MOUNT_GATE_OBSERVATION_STATE_KEY] = build_warroom_v2_compact_ws_status_line_streamlit_visible_mount_gate_observation_packet(
        fragment_summary=fragment_summary,
        messages=[],
        visible_streamlit_mount_requested=False,
        operator_visible_streamlit_mount_ack=False,
        renderer_requested=False,
        operator_renderer_ack=False,
        visible_render_mount_requested=False,
        operator_visible_render_mount_ack=False,
    ...
    # Hidden session_state key: warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation_q32r
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_RENDERER_OBSERVATION_STATE_KEY] = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation_packet(
        fragment_summary=fragment_summary,
        messages=[],
        top_minimal_status_line_render_requested=False,
        operator_top_minimal_status_line_render_ack=False,
        visible_streamlit_mount_requested=False,
        operator_visible_streamlit_mount_ack=False,
        renderer_requested=False,
        operator_renderer_ack=False,
    ...
    # Hidden session_state key: warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation_q32t
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_ACTUAL_MOUNT_GATE_OBSERVATION_STATE_KEY] = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation_packet(
        fragment_summary=fragment_summary,
        messages=[],
    ...
    # Hidden session_state key: warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation_q32v
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_ADAPTER_OBSERVATION_STATE_KEY] = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation_packet(
        fragment_summary=fragment_summary,
        messages=[],
        visible_render_adapter_requested=False,
        operator_visible_render_ack=False,
        ...
        visible_render_mount_requested=False,
        operator_visible_render_mount_ack=False,
        visible_render_adapter_requested_upstream=False,
        operator_visible_render_ack_upstream=False,
        visible_mount_requested=False,
        operator_visible_mount_ack=False,
        status_gate_render_requested=False,
        status_gate_read_only_ack=False,
    )
    # Hidden session_state key: warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_mount_gate_observation_q32x
    st.session_state[WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_MOUNT_GATE_OBSERVATION_STATE_KEY] = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_mount_gate_observation_packet(
        fragment_summary=fragment_summary,
        messages=[],
        visible_render_mount_requested=False,
        operator_visible_render_mount_ack=False,
    ...
    # Hidden session_state key: warroom_v2_ws_receiver_only_client_page_mount_path_hidden_observation_q35b
    st.session_state[WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_PAGE_MOUNT_PATH_HIDDEN_OBSERVATION_STATE_KEY] = build_warroom_v2_ws_receiver_only_client_page_mount_path_hidden_observation_packet(
        fragment_summary=fragment_summary,
        target_write_readback_reset_rollback_packet=st.session_state.get(WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_PAGE_MOUNT_PATH_TARGET_READBACK_STATE_KEY),
        visible_mount_point_packet=st.session_state.get(WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_MOUNT_POINT_STATE_KEY),
        receiver_page_mount_path_requested=bool(st.session_state.get(WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_PAGE_MOUNT_PATH_REQUEST_STATE_KEY, False)),
        operator_receiver_page_mount_path_ack=bool(st.session_state.get(WARROOM_V2_WS_RECEIVER_ONLY_CLIENT_PAGE_MOUNT_PATH_OPERATOR_ACK_STATE_KEY, False)),
    )
...
def _render_warroom_page_body() -> None:
    ...
    with render_warroom_focus_section("push_widget_prediction_cards"):
        _render_warroom_push_widget_prediction_card_wp13()
