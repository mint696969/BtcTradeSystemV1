# path: ./btcts_next/src/btcts/apps/operator_ui/hub/decision_policy_gate_final_registry_status_chain.py
# desc: Read-only chain completion packet for completed decision policy gate final registry chain final status index and registry visibility layers. Metadata aggregation only; no UI implementation, commands, runtime payload loading, final-status-index/chain-completion/registry-visibility/closeout/chain/status/checkpoint builder execution, writes, mode apply, grants, or broker behavior.
...
from btcts.apps.operator_ui.hub.decision_policy_gate_final_registry_status_visibility import (
    DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CONTRACT,
    build_decision_policy_gate_final_registry_chain_final_status_index_registry_visibility_packet,
)

CHAIN_COMPLETION_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion"
CHAIN_COMPLETION_TYPE = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_packet"
FINAL_STATUS_INDEX_SOURCE_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index"
FINAL_COMPONENT_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility"

CHAIN_COMPLETION_COMPONENT_KEYS = (
    FINAL_STATUS_INDEX_SOURCE_KEY,
    FINAL_COMPONENT_KEY,
)
...
DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CHAIN_COMPLETION_CONTRACT = {
    ...
    "dashboard_role": "operator_ui_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion",
    ...
    "final_registry_chain_final_status_index_registry_visibility_chain_completion_only": True,
...
def _catalog_source_component(packet: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        "component_key": FINAL_STATUS_INDEX_SOURCE_KEY,
        "component_type": "final_registry_chain_final_status_index_catalog_source_metadata",
        ...
        "chain_completion_final_status_index_only": bool(entry.get("chain_completion_final_status_index_only", True)),
        "registry_visibility_chain_completion_final_status_index_only": bool(entry.get("registry_visibility_chain_completion_final_status_index_only", True)),
...
def _registry_visibility_component(packet: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "component_type": "final_registry_chain_final_status_index_registry_visibility_metadata",
        ...
        "final_registry_chain_final_status_index_visibility_only": bool(packet.get("final_registry_chain_final_status_index_visibility_only", True)),
...
def build_decision_policy_gate_final_registry_chain_final_status_index_registry_visibility_chain_completion_packet(
    final_status_index_registry_visibility_packet: Mapping[str, Any] | None = None,
) -> dict[str, Any]:
    registry_visibility = _payload(final_status_index_registry_visibility_packet) or build_decision_policy_gate_final_registry_chain_final_status_index_registry_visibility_packet()
    components = (
        _catalog_source_component(registry_visibility),
    ...
    return {
        **DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CHAIN_COMPLETION_CONTRACT,
        ...
        "final_status_index_contract": dict(DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_COMPLETION_FINAL_STATUS_INDEX_CONTRACT),
        "final_status_index_registry_visibility_contract": dict(DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CONTRACT),
        ...
        "summary_line": (
            ...
            "read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion"
        ),
    }
