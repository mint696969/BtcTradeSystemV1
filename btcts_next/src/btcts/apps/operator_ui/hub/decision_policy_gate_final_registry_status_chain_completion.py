# path: ./btcts_next/src/btcts/apps/operator_ui/hub/decision_policy_gate_final_registry_status_chain_completion.py
# desc: Read-only chain completion packet for completed decision policy gate final registry status chain completion and registry visibility layers. Metadata aggregation only; no UI implementation, commands, runtime payload loading, chain-completion/final-status-index/registry-visibility/closeout/chain/status/checkpoint builder execution, writes, mode apply, grants, or broker behavior.
...
CHAIN_COMPLETION_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_registry_visibility_chain_completion"
...
CHAIN_COMPLETION_SOURCE_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion"
FINAL_COMPONENT_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_registry_visibility"
...
DECISION_POLICY_GATE_FINAL_REGISTRY_STATUS_CHAIN_REGISTRY_VISIBILITY_CHAIN_COMPLETION_CONTRACT = {
    ...
    "dashboard_role": "operator_ui_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_registry_visibility_chain_completion",
    ...
    "final_registry_status_chain_registry_visibility_chain_completion_only": True,
...
def _chain_completion_source_component(packet: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "component_type": "final_registry_status_chain_completion_catalog_source_metadata",
...
def _registry_visibility_component(packet: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "component_type": "final_registry_status_chain_registry_visibility_metadata",
...
def build_decision_policy_gate_final_registry_status_chain_registry_visibility_chain_completion_packet(
    final_registry_status_chain_registry_visibility_packet: Mapping[str, Any] | None = None,
) -> dict[str, Any]:
    registry_visibility = _payload(final_registry_status_chain_registry_visibility_packet) or build_decision_policy_gate_final_registry_status_chain_registry_visibility_packet()
    components = (
    ...
    return {
        **DECISION_POLICY_GATE_FINAL_REGISTRY_STATUS_CHAIN_REGISTRY_VISIBILITY_CHAIN_COMPLETION_CONTRACT,
        ...
        "chain_completion_contract": dict(DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CHAIN_COMPLETION_CONTRACT),
        "chain_completion_registry_visibility_contract": dict(DECISION_POLICY_GATE_FINAL_REGISTRY_STATUS_CHAIN_REGISTRY_VISIBILITY_CONTRACT),
        ...
        "summary_line": (
            ...
            "read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_registry_visibility_chain_completion"
        ),
    }
