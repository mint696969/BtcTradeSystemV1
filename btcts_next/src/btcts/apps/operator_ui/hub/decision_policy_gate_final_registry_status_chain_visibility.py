# path: ./btcts_next/src/btcts/apps/operator_ui/hub/decision_policy_gate_final_registry_status_chain_visibility.py
# desc: Read-only registry visibility packet for the decision policy gate final registry status chain completion catalog entry. Catalog/registry metadata only; no UI implementation, commands, runtime payload loading, chain-completion/final-status-index/registry-visibility/closeout/chain/status/checkpoint builder execution, writes, mode apply, grants, or broker behavior.
...
SOURCE_TYPE = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_packet"
VISIBILITY_PACKET_TYPE = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_registry_visibility"
...
DECISION_POLICY_GATE_FINAL_REGISTRY_STATUS_CHAIN_REGISTRY_VISIBILITY_CONTRACT = {
    ...
    "dashboard_role": "operator_ui_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_registry_visibility",
    ...
    "final_status_index_registry_visibility_chain_completion_visibility_only": True,
    "final_registry_chain_status_chain_completion_visibility_only": True,
...
def visible_pages_for_decision_policy_gate_final_registry_status_chain(
...
def build_decision_policy_gate_final_registry_status_chain_registry_visibility_packet(
