# path: ./btcts_next/src/btcts/apps/operator_ui/hub/decision_policy_gate_final_registry_chain_status_index.py
# desc: Final pure data read-only status index for completed decision policy gate final registry chain completion and registry visibility layers. Metadata aggregation only; no UI implementation, commands, runtime payload loading, chain-completion/final-status-index/registry-visibility/closeout/chain/status/checkpoint builder execution, writes, mode apply, grants, or broker behavior.
...
FINAL_STATUS_INDEX_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index"
FINAL_STATUS_INDEX_TYPE = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index_packet"
CHAIN_COMPLETION_SOURCE_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion"
FINAL_COMPONENT_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_registry_visibility"
...
DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_COMPLETION_FINAL_STATUS_INDEX_CONTRACT = {
    ...
    "dashboard_role": "operator_ui_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index",
    ...
    "final_status_index_registry_visibility_chain_completion_final_status_index_only": True,
...
def _source_component(packet: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "component_type": "final_registry_chain_completion_catalog_source_metadata",
...
def _registry_visibility_component(packet: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "component_type": "final_registry_chain_completion_registry_visibility_metadata",
...
def build_decision_policy_gate_final_registry_chain_final_status_index_packet(
    final_registry_chain_registry_visibility_packet: Mapping[str, Any] | None = None,
) -> dict[str, Any]:
    registry_visibility = _payload(final_registry_chain_registry_visibility_packet) or build_decision_policy_gate_final_registry_chain_registry_visibility_packet()
    components = (
    ...
    ready = all(bool(component["ready_for_final_status_index"]) for component in components)
    return {
        **DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_COMPLETION_FINAL_STATUS_INDEX_CONTRACT,
        ...
        "final_registry_chain_final_status_index_ready": ready,
        "visible_pages": visible_pages,
        "visible_page_count": len(visible_pages),
        ...
        "chain_completion_contract": dict(DECISION_POLICY_GATE_CHAIN_COMPLETION_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CHAIN_COMPLETION_CONTRACT),
        "chain_completion_registry_visibility_contract": dict(DECISION_POLICY_GATE_FINAL_REGISTRY_CHAIN_COMPLETION_REGISTRY_VISIBILITY_CONTRACT),
        "not_loaded_as_runtime_display_source": True,
        "summary_line": (
            f"{FINAL_STATUS_INDEX_KEY}: components={len(components)} / "
            f"final_registry_chain_final_status_index_ready={_bool_token(ready)} / "
            f"final_component={FINAL_COMPONENT_KEY} / "
            "read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_registry_visibility_chain_completion_final_status_index"
        ),
    }
