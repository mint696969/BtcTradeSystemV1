# path: ./btcts_next/src/btcts/apps/operator_ui/hub/decision_policy_gate_chain_completion_final_status_index.py
# desc: Final pure data read-only status index for completed decision policy gate closeout review chain closeout final status index registry visibility chain completion and registry visibility layers. Registry-visibility metadata aggregation only; no UI implementation, commands, runtime payload loading, chain-completion/chain-closeout-final-status-index/chain-closeout-summary/final/closeout/chain/status/checkpoint builder execution, writes, mode apply, grants, or broker behavior.
...
CHAIN_COMPLETION_FINAL_STATUS_INDEX_KEY = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index"
CHAIN_COMPLETION_FINAL_STATUS_INDEX_TYPE = "decision_policy_gate_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_packet"
CHAIN_COMPLETION_SOURCE_KEY = "decision_policy_gate_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion"
FINAL_COMPONENT_KEY = "decision_policy_gate_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_registry_visibility"
...
DECISION_POLICY_GATE_VISIBILITY_REGISTRY_CHAIN_COMPLETION_CLOSEOUT_REVIEW_CHAIN_CLOSEOUT_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CHAIN_COMPLETION_FINAL_STATUS_INDEX_CONTRACT = {
    "final_status_index_key": CHAIN_COMPLETION_FINAL_STATUS_INDEX_KEY,
    "final_status_index_type": CHAIN_COMPLETION_FINAL_STATUS_INDEX_TYPE,
    "dashboard_role": "operator_ui_read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index",
...
def _source_component(packet: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "component_type": "chain_completion_catalog_source_metadata",
        ...
        "chain_closeout_final_status_index_registry_visibility_chain_completion_only": bool(entry.get("chain_closeout_final_status_index_registry_visibility_chain_completion_only", True)),
        ...
        "ready_for_chain_completion_final_status_index": ready,
    }
...
def _registry_visibility_component(packet: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "component_type": "chain_completion_registry_visibility_metadata",
...
def build_decision_policy_gate_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index_packet(
    chain_completion_registry_visibility_packet: Mapping[str, Any] | None = None,
) -> dict[str, Any]:
    registry_visibility = _payload(chain_completion_registry_visibility_packet) or build_decision_policy_gate_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_registry_visibility_packet()
    components = (
    ...
    final_status_index_ready = all(bool(component["ready_for_chain_completion_final_status_index"]) for component in components)
    return {
        **DECISION_POLICY_GATE_VISIBILITY_REGISTRY_CHAIN_COMPLETION_CLOSEOUT_REVIEW_CHAIN_CLOSEOUT_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CHAIN_COMPLETION_FINAL_STATUS_INDEX_CONTRACT,
        "final_status_index_components": CHAIN_COMPLETION_FINAL_STATUS_INDEX_COMPONENT_KEYS,
        ...
        "chain_completion_final_status_index_ready": final_status_index_ready,
        "visible_pages": visible_pages,
        "visible_page_count": len(visible_pages),
        ...
        "chain_completion_contract": dict(DECISION_POLICY_GATE_VISIBILITY_REGISTRY_CHAIN_COMPLETION_CLOSEOUT_REVIEW_CHAIN_CLOSEOUT_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CHAIN_COMPLETION_CONTRACT),
        "chain_completion_registry_visibility_contract": dict(VISIBILITY_REGISTRY_CHAIN_COMPLETION_CLOSEOUT_REVIEW_CHAIN_CLOSEOUT_FINAL_STATUS_INDEX_REGISTRY_VISIBILITY_CHAIN_COMPLETION_REGISTRY_VISIBILITY_CONTRACT),
        "not_loaded_as_runtime_display_source": True,
        "summary_line": (
            f"{CHAIN_COMPLETION_FINAL_STATUS_INDEX_KEY}: components={len(components)} / "
            f"chain_completion_final_status_index_ready={_bool_token(final_status_index_ready)} / "
            f"final_component={FINAL_COMPONENT_KEY} / "
            "read_only_visibility_registry_chain_completion_closeout_review_chain_closeout_final_status_index_registry_visibility_chain_completion_final_status_index"
        ),
    }
