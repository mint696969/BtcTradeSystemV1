# path: ./btcts_next/src/btcts/apps/operator_ui/components/warroom_timeline_state.py
# desc: War Room timeline 用の live-first / replay-fallback state builder.
...
def build_warroom_timeline_state(*, lang: str) -> dict:
    ...
    if not timeline:
        timeline = _build_replay_timeline(
            lang=lang,
    ...
    return {
        "timeline": timeline,
        "timeline_is_live": timeline_is_live,
    }