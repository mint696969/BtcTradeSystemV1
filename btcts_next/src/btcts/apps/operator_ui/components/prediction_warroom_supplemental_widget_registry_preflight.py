...
_EXPECTED_ATTACH_POINTS = {
    ...
    "prediction_authorization_handoff_status_widget": "prediction_latest_payload_loader_authorization_registry_summary_widget",
}
_EXPECTED_INDEX_VERSIONS = {EXPLANATION_WIDGET_GROUP_VERSION, DRY_RUN_WIDGET_GROUP_VERSION, AUTHORIZATION_WIDGET_GROUP_VERSION, AUTHORIZATION_REGISTRY_SUMMARY_WIDGET_GROUP_VERSION, AUTHORIZATION_HANDOFF_STATUS_WIDGET_GROUP_VERSION}
...
def validate_prediction_warroom_supplemental_widget_registry_schema(
    ...
    return _finish(
        ...
        checked_contracts=(SUPPLEMENTAL_WIDGET_REGISTRY_VERSION, EXPLANATION_WIDGET_GROUP_VERSION, DRY_RUN_WIDGET_GROUP_VERSION, AUTHORIZATION_WIDGET_GROUP_VERSION, AUTHORIZATION_REGISTRY_SUMMARY_WIDGET_GROUP_VERSION, AUTHORIZATION_HANDOFF_STATUS_WIDGET_GROUP_VERSION, WIDGET_GROUP_PACKET_VERSION),
    )
...
def build_prediction_warroom_supplemental_widget_registry_preflight_report(
    *,
    ...
    return _finish(
        ...
        checked_contracts=(SUPPLEMENTAL_WIDGET_REGISTRY_VERSION, EXPLANATION_WIDGET_GROUP_VERSION, DRY_RUN_WIDGET_GROUP_VERSION, AUTHORIZATION_WIDGET_GROUP_VERSION, AUTHORIZATION_REGISTRY_SUMMARY_WIDGET_GROUP_VERSION, AUTHORIZATION_HANDOFF_STATUS_WIDGET_GROUP_VERSION, WIDGET_GROUP_PACKET_VERSION, BASE_PAYLOAD_VALIDATOR_VERSION),
    )
