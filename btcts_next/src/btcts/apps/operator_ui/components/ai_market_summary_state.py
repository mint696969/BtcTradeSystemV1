# path: ./btcts_next/src/btcts/apps/operator_ui/components/ai_market_summary_state.py
# desc: AI market summary panel 用の market signal state adapter.
...
def build_ai_market_summary_state() -> AiMarketSummaryState | None:
