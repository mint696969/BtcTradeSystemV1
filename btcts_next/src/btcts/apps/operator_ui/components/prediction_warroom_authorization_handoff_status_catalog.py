...
EXPECTED_SUPPLEMENTAL_WIDGET_GROUP_COUNT = 4
EXPECTED_TOTAL_WIDGET_GROUP_COUNT = 10
EXPECTED_VISIBILITY_GROUP_COUNT = 5
...
def build_prediction_warroom_authorization_handoff_status_catalog(
    *,
    ...
    chain = {
        ...
        "combined_widget_group_order_tail": combined_order[-4:],
