# path: ./btcts_next/src/btcts/apps/operator_ui/prediction_warroom/panels/warroom_latest_prediction_quick_status_panel.py
# desc: WarRoom latest prediction quick-status panel implementation. Extracted from warroom_page; display-only and non-executing.
...
WARROOM_LATEST_PREDICTION_QUICK_STATUS_PANEL_VERSION = "prediction_warroom.latest_prediction_quick_status_panel.ps_q26r.v1"
