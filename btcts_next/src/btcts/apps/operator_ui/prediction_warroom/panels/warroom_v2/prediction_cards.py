...
from .card_detail_overlay_html import warroom_v2_detail_overlay_css, warroom_v2_detail_overlay_html
from .card_visual_semantics import build_warroom_v2_card_visual_semantics_packet, warroom_v2_card_visual_semantics_css

WARROOM_V2_PREDICTION_CARDS_RENDERER_VERSION = "prediction_warroom.v2.prediction_cards_renderer.ps_q29m.v1"
...
def _card_html(parent: dict[str, Any], horizon_card: dict[str, Any]) -> str:
    ...
    detail = warroom_v2_detail_overlay_html(model)
