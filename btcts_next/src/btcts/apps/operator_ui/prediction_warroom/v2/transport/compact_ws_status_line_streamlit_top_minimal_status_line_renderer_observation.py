# path: ./btcts_next/src/btcts/apps/operator_ui/prediction_warroom/v2/transport/compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation.py
# desc: WarRoom v2 hidden compact WS status line top minimal renderer observation. Pure packet only; no UI, sockets, IO, order send, or polling fallback.

from __future__ import annotations

from typing import Any, Iterable, Mapping

from .compact_ws_status_line_streamlit_top_minimal_status_line_renderer import build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_contract, build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_packet

WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_RENDERER_OBSERVATION_VERSION = "prediction_warroom.v2.transport.compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation.ps_q32r.v1"
WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_RENDERER_OBSERVATION_STATE_KEY = "warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation_q32r"


def build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation_contract() -> dict[str, Any]:
    contract = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_contract()
    return {
        "ok": True,
        "observation_version": WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_RENDERER_OBSERVATION_VERSION,
        "state_key": WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_RENDERER_OBSERVATION_STATE_KEY,
        "observation_kind": "warroom_v2_hidden_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation_packet",
...
def build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation_packet(
    *,
    ...
    renderer_packet = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_packet(
    ...
    return {
        **build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation_contract(),
        "packet_kind": "warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_renderer_observation_packet",
        "fragment_summary": dict(fragment_summary or {}),
        "compact_ws_status_line_streamlit_top_minimal_status_line_renderer_packet": renderer_packet,
        "renderer_status": str(renderer_packet.get("renderer_status") or ""),
        "top_minimal_status_line_render_requested": bool(renderer_packet.get("top_minimal_status_line_render_requested")),
        "operator_top_minimal_status_line_render_ack": bool(renderer_packet.get("operator_top_minimal_status_line_render_ack")),
        "upstream_mount_allowed_for_future_warroom_page": bool(renderer_packet.get("upstream_mount_allowed_for_future_warroom_page")),
        "future_streamlit_call_ready": bool(renderer_packet.get("future_streamlit_call_ready")),
        "future_streamlit_call_model": dict(renderer_packet.get("future_streamlit_call_model") or {}),
