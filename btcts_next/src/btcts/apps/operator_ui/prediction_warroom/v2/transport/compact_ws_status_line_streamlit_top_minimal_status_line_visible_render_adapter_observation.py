# path: ./btcts_next/src/btcts/apps/operator_ui/prediction_warroom/v2/transport/compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation.py
# desc: WarRoom v2 hidden compact WS status line top minimal visible render adapter observation. Pure packet only; no UI, sockets, IO, order send, or polling fallback.

from __future__ import annotations

from typing import Any, Iterable, Mapping

from .compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter import build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_contract, build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_packet

WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_ADAPTER_OBSERVATION_VERSION = "prediction_warroom.v2.transport.compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation.ps_q32v.v1"
WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_ADAPTER_OBSERVATION_STATE_KEY = "warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation_q32v"


def build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation_contract() -> dict[str, Any]:
    contract = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_contract()
    return {
        "ok": True,
        "observation_version": WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_ADAPTER_OBSERVATION_VERSION,
        "state_key": WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_VISIBLE_RENDER_ADAPTER_OBSERVATION_STATE_KEY,
        "observation_kind": "warroom_v2_hidden_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation_packet",
        "input_pipeline": ["q32t_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation", "q32u_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter"],
...
def build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation_packet(
    *,
    ...
    adapter_packet = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_packet(
        ...
        visible_render_adapter_requested_upstream=visible_render_adapter_requested_upstream,
        operator_visible_render_ack_upstream=operator_visible_render_ack_upstream,
    ...
    return {
        **build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation_contract(),
        "packet_kind": "warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_observation_packet",
        "fragment_summary": dict(fragment_summary or {}),
        "compact_ws_status_line_streamlit_top_minimal_status_line_visible_render_adapter_packet": adapter_packet,
        ...
        "upstream_actual_mount_allowed_for_future_warroom_page": bool(adapter_packet.get("upstream_actual_mount_allowed_for_future_warroom_page")),
        "render_payload_ready_for_future_streamlit_mount": bool(adapter_packet.get("render_payload_ready_for_future_streamlit_mount")),
        "future_streamlit_call_model": dict(adapter_packet.get("future_streamlit_call_model") or {}),
        "renderer_model": dict(adapter_packet.get("renderer_model") or {}),
