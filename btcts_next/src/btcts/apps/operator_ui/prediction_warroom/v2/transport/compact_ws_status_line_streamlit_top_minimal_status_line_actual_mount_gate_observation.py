# path: ./btcts_next/src/btcts/apps/operator_ui/prediction_warroom/v2/transport/compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation.py
# desc: WarRoom v2 hidden compact WS status line top minimal actual mount gate observation. Pure packet only; no UI, sockets, IO, order send, or polling fallback.

from __future__ import annotations

from typing import Any, Iterable, Mapping

from .compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate import build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_contract, build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_packet

WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_ACTUAL_MOUNT_GATE_OBSERVATION_VERSION = "prediction_warroom.v2.transport.compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation.ps_q32t.v1"
WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_ACTUAL_MOUNT_GATE_OBSERVATION_STATE_KEY = "warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation_q32t"


def build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation_contract() -> dict[str, Any]:
    contract = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_contract()
    return {
        "ok": True,
        "observation_version": WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_ACTUAL_MOUNT_GATE_OBSERVATION_VERSION,
        "state_key": WARROOM_V2_COMPACT_WS_STATUS_LINE_STREAMLIT_TOP_MINIMAL_STATUS_LINE_ACTUAL_MOUNT_GATE_OBSERVATION_STATE_KEY,
        "observation_kind": "warroom_v2_hidden_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation_packet",
...
def build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation_packet(
    *,
    ...
    gate_packet = build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_packet(
    ...
    return {
        **build_warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation_contract(),
        "packet_kind": "warroom_v2_compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_observation_packet",
        "fragment_summary": dict(fragment_summary or {}),
        "compact_ws_status_line_streamlit_top_minimal_status_line_actual_mount_gate_packet": gate_packet,
        "gate_status": str(gate_packet.get("gate_status") or ""),
        "actual_mount_requested": bool(gate_packet.get("actual_mount_requested")),
        "operator_actual_mount_ack": bool(gate_packet.get("operator_actual_mount_ack")),
        "upstream_future_streamlit_call_ready": bool(gate_packet.get("upstream_future_streamlit_call_ready")),
        "actual_mount_allowed_for_future_warroom_page": bool(gate_packet.get("actual_mount_allowed_for_future_warroom_page")),
