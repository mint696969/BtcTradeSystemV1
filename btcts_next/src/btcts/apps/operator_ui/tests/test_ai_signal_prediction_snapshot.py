# path: ./btcts_next/src/btcts/apps/operator_ui/tests/test_ai_signal_prediction_snapshot.py
# desc: Verify ai_signal_panel can reuse shared prediction snapshot helper safely.
...
def main() -> int:
    ...
    assert "confidence=0.55" in lines
