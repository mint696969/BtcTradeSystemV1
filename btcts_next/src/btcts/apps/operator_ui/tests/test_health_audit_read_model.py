...
def main() -> int:
    assert audit_max_lines_for_range("1h") == 50000
    assert audit_max_lines_for_range("24h") == 120000
    assert audit_max_lines_for_range("1w") == 240000
    assert audit_max_lines_for_range("unknown") == 50000
    ...
    assert audit_input.max_lines == 120000
    ...
    assert payload["max_lines"] == 120000
