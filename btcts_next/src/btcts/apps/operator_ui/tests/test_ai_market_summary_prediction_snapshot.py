# path: ./btcts_next/src/btcts/apps/operator_ui/tests/test_ai_market_summary_prediction_snapshot.py
# desc: Verify ai_market_summary_panel uses shared prediction snapshot helper safely.
