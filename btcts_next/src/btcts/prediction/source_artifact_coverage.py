...
def build_default_reference_source_registry() -> Tuple[ReferenceSourceRegistryEntry, ...]:
    ...
    entries = (
        ...
        _entry("ohlcv_6h", "prediction_or_collector", "ohlcv", EvidenceTier.TIER_2_TECHNICAL_STRUCTURE, ArtifactOwner.COLLECTOR, "ohlcv_6h", "OHLCV 6h", (SourceEffect.CONFIRM, SourceEffect.STRENGTHEN, SourceEffect.WARN), default_weight=0.30),
        _entry("ohlcv_12h", "prediction_or_collector", "ohlcv", EvidenceTier.TIER_2_TECHNICAL_STRUCTURE, ArtifactOwner.COLLECTOR, "ohlcv_12h", "OHLCV 12h", (SourceEffect.CONFIRM, SourceEffect.STRENGTHEN, SourceEffect.WARN), default_weight=0.27),
...
def build_default_context_evidence_profiles() -> Tuple[ContextEvidenceProfile, ...]:
    return (
        ...
        ContextEvidenceProfile(
            ...
            minimum_required_sources=("macro_context", "session_calendar_context", "ohlcv_4h", "ohlcv_6h", "ohlcv_12h", "ohlcv_1d"),
            minimum_required_tiers=(EvidenceTier.TIER_5_MACRO_SESSION_EVENT, EvidenceTier.TIER_2_TECHNICAL_STRUCTURE),
            context_weight_overrides={"macro_context": 0.60, "session_calendar_context": 0.40, "ohlcv_4h": 0.40, "ohlcv_6h": 0.45, "ohlcv_12h": 0.45, "ohlcv_1d": 0.45},
