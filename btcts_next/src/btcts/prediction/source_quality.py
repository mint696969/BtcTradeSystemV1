...
_DEFAULT_PROVIDER_FAMILIES: Dict[str, str] = {
    ...
    "bitflyer_local_fx": "bitflyer_local_fx",
    "bitflyer_local_spot": "bitflyer_local_spot",
    "bitflyer_trades": "bitflyer_local_fx",
    "bitflyer_board": "bitflyer_local_fx",
    "bitflyer_board_summary": "bitflyer_local_fx",
    "ohlcv": "prediction_ohlcv",
    "prediction_ohlcv": "prediction_ohlcv",
    "macro_context": "prediction_neutral_context_default",
    "session_calendar_context": "prediction_neutral_context_default",
    "prediction_neutral_context_default": "prediction_neutral_context_default",
    "provider_source_reliability_state": "prediction_source_quality",
    "prediction_source_quality": "prediction_source_quality",
