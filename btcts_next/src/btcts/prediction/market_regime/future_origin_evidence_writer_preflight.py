...
def build_origin_evidence_writer_preflight(
    *,
    ...
    return MappingProxyType({
        ...
        "approval_requested_at": (approval.get("requested_at") if approval is not None else None),
        "approval_expires_at": (approval.get("expires_at") if approval is not None else None),
        "preflight_executed_at": (executed_at if approval is not None else None),
