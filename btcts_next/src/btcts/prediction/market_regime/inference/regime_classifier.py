        ...
        prediction_rows.append(
            MarketRegimePrediction(
                ...
                diagnostic_record={
                    ...
                    "current_state_shadow_transition_policy_version": current_estimate.get("shadow_transition_policy_version") if int(horizon.horizon_sec) == 0 else "",
                    "current_state_shadow_transition_previous_regime": current_estimate.get("shadow_transition_previous_regime") if int(horizon.horizon_sec) == 0 else "UNKNOWN",
                    "current_state_shadow_transition_candidate_regime": current_estimate.get("shadow_transition_candidate_regime") if int(horizon.horizon_sec) == 0 else "UNKNOWN",
                    "current_state_shadow_transition_accepted_regime": current_estimate.get("shadow_transition_accepted_regime") if int(horizon.horizon_sec) == 0 else "UNKNOWN",
                    "current_state_shadow_transition_decision": current_estimate.get("shadow_transition_decision") if int(horizon.horizon_sec) == 0 else "unknown",
                    "current_state_shadow_transition_blockers": current_estimate.get("shadow_transition_blockers") if int(horizon.horizon_sec) == 0 else [],
                    "current_state_shadow_transition_allowed": current_estimate.get("shadow_transition_allowed") if int(horizon.horizon_sec) == 0 else False,
                    "current_state_shadow_transition_dwell_satisfied": current_estimate.get("shadow_transition_dwell_satisfied") if int(horizon.horizon_sec) == 0 else False,
                    "current_state_shadow_transition_hysteresis_satisfied": current_estimate.get("shadow_transition_hysteresis_satisfied") if int(horizon.horizon_sec) == 0 else False,
                    "current_state_shadow_transition_change_point_override_applied": current_estimate.get("shadow_transition_change_point_override_applied") if int(horizon.horizon_sec) == 0 else False,
                    "current_state_shadow_transition_candidate_margin": current_estimate.get("shadow_transition_candidate_margin") if int(horizon.horizon_sec) == 0 else None,
                    "current_state_shadow_transition_penalty": current_estimate.get("shadow_transition_penalty") if int(horizon.horizon_sec) == 0 else None,
                    "current_state_shadow_persistence_probability": current_estimate.get("shadow_persistence_probability") if int(horizon.horizon_sec) == 0 else None,
                    "current_state_shadow_persistence_probability_calibrated": current_estimate.get("shadow_persistence_probability_calibrated") if int(horizon.horizon_sec) == 0 else False,
                    "current_state_shadow_transition_observation_only": current_estimate.get("shadow_transition_observation_only") if int(horizon.horizon_sec) == 0 else False,
                    "current_state_shadow_transition_applied_to_selected_label": current_estimate.get("shadow_transition_applied_to_selected_label") if int(horizon.horizon_sec) == 0 else False,
