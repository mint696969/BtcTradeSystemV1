...
# 候補: 旧ファイル名
$oldAudit = Get-ChildItem -Path $DashDir -Recurse -Filter 'audit_ui.py' -ErrorAction SilentlyContinue
$oldHealth = Get-ChildItem -Path $DashDir -Recurse -Filter 'health_ui.py' -ErrorAction SilentlyContinue
